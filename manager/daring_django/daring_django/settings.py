...
SECRET_KEY = '@3u_8@jfrfhua_gl&reqv#^fvq+5z%ivp!@kv_s_kb-_83oj@l'
...
ROOT_URLCONF = 'daring_django.urls'
...
WSGI_APPLICATION = 'daring_django.wsgi.application'
